                ...
                if old_link_info:
                    ...
                    if link_created_time and (current_time - link_created_time).total_seconds() < 240:
                        ...
                        invite = await client.create_chat_invite_link(
                            chat_id=channel_id,
                            expire_date=current_time + timedelta(seconds=10),
                ...
                try:
                    ...
                    if mode == "on" and not data.username:
                        invite = await client.create_chat_invite_link(
                            ...
                            expire_date=datetime.utcnow() + timedelta(seconds=10)
                        )
...
async def cb_handler(client: Bot, query: CallbackQuery):
    ...
    if data == "close":
        ...
        await query.edit_message_media(
            InputMediaPhoto(
                "https://4kwallpapers.com/images/walls/thumbs_2t/24805.jpg",
                ABOUT_TXT
            ),
        ...
        await query.edit_message_media(
            InputMediaPhoto("https://4kwallpapers.com/images/walls/thumbs_2t/24805.jpg",
                            CHANNELS_TXT
            ),
            reply_markup=InlineKeyboardMarkup([
